...
public class GameScreen extends ScreenAdapter
{
    ...
    private FitViewport viewport; // Zone d'affichage de la camera
    ...
    public GameScreen()
    {
        ...
        viewport = new FitViewport(1024, 720, camera); // 80, 80 * (720f/1024f) // Largeur et hauteur de la zone d'affichage (=viewport) qu'on relie à la caméra, (la hauteur c'est un ratio de la fenêtre)
        viewport.apply();
    ...
    public void resize(int largeur, int hauteur)
    {
        ...
        viewport.update(largeur, hauteur);
        //camera.viewportWidth = 80;
        //camera.viewportHeight = 80 * (720f / 1024f);
        camera.update();
    }
